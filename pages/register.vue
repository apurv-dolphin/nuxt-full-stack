  ...
  <div class="flex items-center min-h-screen p-4 lg:justify-center">
    ...
    >
      ...
      >
        ...
        <p class="mt-6 font-normal text-left text-gray-300 md:mt-0">
          Working with Apurv ensures high-quality results and dedicated support
          throughout the project. Our commitment to excellence extends beyond
          project completion; we provide ongoing assistance and address any
          queries even after the project is finished.
        </p>
      ...
      <div class="p-5 bg-white md:flex-1">
        ...
        <form class="flex flex-col space-y-5" @submit.prevent="handleSubmit">
          <div class="flex flex-col space-y-1">
            <label for="firstname" class="text-sm font-semibold text-gray-500"
              >First Name</label
            >
            <input
              type="text"
          ...
          <div class="flex flex-col space-y-5">
            ...
            <div class="flex flex-col space-y-4">
              ...
              >
                ...
                <span
                  class="text-sm font-medium text-blue-500 group-hover:text-white"
                  >Twitter</span
                >
              </a>
            </div>
