      ...
      <div class="flex flex-wrap items-center sm:-mx-3">
        <div class="w-full md:w-1/2 md:px-3">
          ...
          >
            ...
            >
              <p class="block xl:inline">Useful Tools</p>
            </h1>
            <h3
        ...
        <div class="items-center justify-center w-full mt-12 mb-4 lg:flex">
          ...
          >
            <div class="flex items-center justify-center">
              ...
              >
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXeCwtLSNuG7ABFqBx_2mk5DcEuPPSBoht4A&usqp=CAU"
                  class="object-cover w-full h-full"
                />
              </div>
              <div class="flex flex-col items-start justify-center">
                <h4 class="font-bold text-gray-800">Doremon</h4>
                <p class="text-gray-600">Main Charecter of the show</p>
              </div>
            </div>
          ...
          >
            <div class="flex items-center justify-center">
              ...
              >
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRefpyTA2-FoilVvxG-FnoSGBHxIsKRwys4pw&usqp=CAU"
                  class="object-scale-down w-full h-full"
                />
              </div>
              <div class="flex flex-col items-start justify-center">
                <h4 class="font-bold text-gray-800">Nobita</h4>
                <p class="text-gray-600">Main Charecter of the show</p>
              </div>
            </div>
            <blockquote class="mt-8 text-lg text-gray-500">
          ...
          >
            <div class="flex items-center justify-center">
              ...
              >
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSX0aeeIjoERRA1PS3UtKB17Te2wfb0MFibtg4v-PhKk2xv-IDS2eb4cjdLE-OH7F3arw&usqp=CAU"
                  class="object-scale-down w-full h-full"
                />
              </div>
              <div class="flex flex-col items-start justify-center">
                <h4 class="font-bold text-gray-800">Sizuka</h4>
                <p class="text-gray-600">
                  Main Charecter of the show (Gold degger)
                </p>
              </div>
            </div>
            <blockquote class="mt-8 text-lg text-gray-500">
